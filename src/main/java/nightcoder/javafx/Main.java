...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        DialogBox dialogBox = new DialogBox("Hello!", userImage, true);
        dialogContainer.getChildren().addAll(dialogBox);

        DialogBox dialogBox2 = new DialogBox("Hello!", botImage, false);
        dialogContainer.getChildren().addAll(dialogBox2);
